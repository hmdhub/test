...
"""
%Author     :hmd
%FileName   :python复习元组集合.py
%Time       :2022/10/12 9:48
"""
#  元组
...
# 添加
ff.add('122222')
print(ff)  # {tengxun, 2, 3, 4, '122222'}
# 删除
ff.remove(4)
print(ff) # {tengxun, 2, 3, '122222'}
# 集合中的set 可以直接去重
...
print(set,type(set))  #{tengxun, 2, 3, 4} <class 'set'>