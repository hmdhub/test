...
for v in a:
    print(v, a[v], '我是第三种循环')
#  创建
b = dict([(1, 'c'), (2, 'b'), (3, 'j')])  # {1: 'c', 2: 'b', 3: 'j'}
print(b)
c = {}  # 创建空字典
print(c)
# 添加 （如果没有会自动创建）
b[4] = "帅哥"
print(b)  # {1: 'c', 2: 'b', 3: 'j', 4: '帅哥'}
# 清空
cc = c.clear()  # None
print(cc)
# 修改
b[2] = 'cmd'
print(b)  # {1: 'c', 2: 'cmd', 3: 'j'}
# 删除
del b[1]  # {2: 'cmd', 3: 'j'}
print(b)
# 更新
...
dd = b.get(1)  # c
print(dd)
print(len(b), b)  # {2: 8, 3: 27, 4: 64, 1: 1} <class 'dict'>
# 字典的推导式
dic = {
    x:x**3 for x in (2, 3, 4, 1, 2, 1)
}
print(dic,type(dic)) # {2: 4, 3: 9, 4: 16, 1: 1}
#
